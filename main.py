...
Version 1.4
Sprinting Buffalo
More UI Improvements; implemented win conditon check
'''
...
if __name__ == "__main__":
    ...
    eval_1       = gu.Evaluator_1(                         title_private="EVAL_1",       manufacturer='DD',  title_public='QA Department',  loud_debug=False)
